...
class OrderRepositoryTest {
    ...
    void setUp() {
        ...
        // Asumsi: Konstruktor Order default statusnya adalah "WAITING_PAYMENT" atau serupa
    ...
    void testSaveUpdate() {
        ...
        // Membuat objek baru dengan ID yang sama tapi status berbeda untuk simulasi update
        Order newOrder = new Order(order.getId(), order.getProducts(), order.getOrderTime(),
                order.getAuthor());
        newOrder.setStatus(OrderStatus.SUCCESS.getValue());
